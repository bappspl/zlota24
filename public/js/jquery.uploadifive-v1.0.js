        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'buttonText'      : 'Wybierz plik',     // The text that appears on the UploadiFive button
                ...
                $data.removeQueueItem = function(file, instant, delay) {
                    ...
                    if (file.queueItem) {
                        if (file.queueItem.find('.fileinfo').html() != ' - Zakończono') {
                            file.queueItem.find('.fileinfo').html(' - Anulowano');
                        }
                ...
                $data.checkExists = function(file) {
                    if ($.inArray('onCheck', settings.overrideEvents) < 0) {
                        ...
                        if (file.exists) {
                            if (!confirm('Plik o nazwie : ' + file.name + ' już istnieje.\nChcesz go podmienić?')) {
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    if ($.inArray('onUploadComplete', settings.overrideEvents) < 0) {
                        ...
                        file.queueItem.find('.fileinfo').html(' - Zakończono');
